...
const Cart = () => {
  ...
  const handleClearCart = () => {
    if (cart.products && cart.products.length > 0) {
      alert("You are about to clear your cart");
      dispatch(clearCart());
    }
    if (cart.products && cart.products.length === 0) {
  ...
  useEffect(() => {
    ...
    const makePaymentRequest = async () => {
      // https://dallolmart.herokuapp.com/
      console.log("before:", cart);
      try {
        const res = await axios.post("http://localhost:5200/checkout/payment", {
      ...
      {user ? (
        <>
          <Wrapper>
            ...
            <Top>
              <TopButton onClick={handleContinue}>Continue Shoping</TopButton>
              <TopTextContainer>
            ...
            <Bottom>
              ...
              {cart.totalAmount ? (
                ...
                <span style={{color: "red", margin: "2% 40%"}}>
                  Ooops ! Your shoping Cart is Empty!
                </span>
              )}
            </Bottom>
          </Wrapper>
