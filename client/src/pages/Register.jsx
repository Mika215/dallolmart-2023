...
const Register = () => {
  ...
  const handleRegistartion = async (e) => {
    ...
    if (password !== confirmedPassword) {
      ...
      //!change this url to the main one
      console.log("url has been changed chek it Mika");
      // "https://dallolmart.herokuapp.com/users/register",

      const res = await axios.post(
        "http://localhost:5200/users/register",
        newUser
      );
